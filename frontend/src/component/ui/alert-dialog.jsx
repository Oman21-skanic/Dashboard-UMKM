...
const AlertDialogOverlay = React.forwardRef(({ className, ...props }, ref) => <AlertDialogPrimitive.Overlay
  className={cn(
...
const AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) => <AlertDialogPrimitive.Cancel
  ref={ref}
