...
const kpiCards = [
  {
    ...
    value: "Rp128,4jt",
    change: "+12.5%",
    description: "Total akumulasi 2 platform",
    icon: ShoppingBag,
  ...
  },
  {
    ...
    value: "1,240",
    change: "+8.2%",
    description: "Pesanan valid terverifikasi",
    icon: ShoppingCart,
  ...
  },
  {
    ...
    value: "3.8%",
    change: "+4.2% ROAS",
    description: "Dari total traffic masuk",
    icon: Percent,
  ...
  },
  {
    ...
    value: "12.5K",
    change: "+14%",
    description: "Dominasi dari TikTok Shop",
    icon: Users,
...
const trendData = [
  6, 9, 12, 10, 14, 18, 16, 12, 20, 11, 15, 21, 17, 13, 19, 22, 14, 16,
  24, 13, 12, 18, 14, 20, 16, 26, 19, 22, 18, 20,
].map((value, index) => ({
  day: index + 1,
  value,
}));

const highlightDays = new Set([26]);
...
const topProducts = [
  { name: "Sabun Aloe Vera", sales: "452 pcs sold", change: "+12%" },
  { name: "Serum Glowing", sales: "312 pcs sold", change: "+8%" },
  { name: "Toner Vit C Serum", sales: "289 pcs sold", change: "0%" },
  { name: "Herbal Face Scrub", sales: "145 pcs sold", change: "-5%" },
];

const comparisonData = [
  { day: "Mon", tiktok: 8, shopee: 6 },
  { day: "Tue", tiktok: 12, shopee: 10 },
  { day: "Wed", tiktok: 10, shopee: 13 },
  { day: "Thu", tiktok: 15, shopee: 9 },
  { day: "Fri", tiktok: 12, shopee: 14 },
  { day: "Sat", tiktok: 18, shopee: 16 },
  { day: "Sun", tiktok: 16, shopee: 19 },
];

const logisticsSummary = [
  {
    label: "Dalam Perjalanan",
    detail: "320 Paket sedang dikirim kurir",
    percent: 25.8,
    color: "#102e4a",
    icon: Truck,
  ...
  },
  {
    ...
    detail: "850 Paket telah sampai tujuan",
    percent: 68.5,
    color: "#059669",
    icon: CheckCircle2,
...
const statusLogistics = [
  { name: "Selesai", value: 850, color: "#102e4a" },
  { name: "Dikirim", value: 320, color: "#38bdf8" },
];

const statusTone = {
  Dikirim: "bg-[#eaf3fc] text-[#1c4f7a]",
  Selesai: "bg-[#e7f7ef] text-[#1f9d6a]",
            ...
            <section className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-end">
              <div>
                <h2 className="text-2xl font-semibold text-[#0f172a]">
                  Performa TikTok Shop & Shopee 👋
                </h2>
                <p className="text-sm text-[#94a3b8]">
                  Update real-time: Jumat, 27 Februari 2026
                </p>
              </div>
              ...
              <Card className="border-[#eef2f7] shadow-[0_18px_40px_rgba(15,42,67,0.08)]">
                <CardHeader className="flex-row items-center justify-between space-y-0">
                  <div>
                    ...
                    <p className="text-xs text-[#7c8ca0]">
                      Daftar transaksi terbaru dari semua channel
                    </p>
                  </div>
                  <button className="text-xs font-semibold text-[#1c4f7a]">
                    Lihat Semua
                  </button>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="space-y-3 md:hidden">
                    {recentOrders.map((order) => (
                      <div
                        key={`${order.name}-${order.time}-mobile`}
              ...
              <Card className="border-[#eef2f7] shadow-[0_18px_40px_rgba(15,42,67,0.08)]">
                <CardHeader className="flex-row items-center justify-between space-y-0">
                  <div>
                    ...
                    <p className="text-xs text-[#7c8ca0]">
                      Perbandingan penjualan TikTok vs Shopee (Mingguan)
                    </p>
                  </div>
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={comparisonData} barGap={6}>
                      ...
                      <Tooltip
                        ...
                        labelStyle={{ color: "#0f2a43", fontWeight: 700 }}
                      />
                      <Bar dataKey="tiktok" fill="#102e4a" radius={[6, 6, 0, 0]} />
                      <Bar dataKey="shopee" fill="#f97316" radius={[6, 6, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
            ...
            <section className="grid gap-6 xl:grid-cols-[1.6fr_1fr]">
              <Card className="border-[#eef2f7] shadow-[0_18px_40px_rgba(15,42,67,0.08)]">
                <CardHeader>
                  ...
                  <p className="text-xs text-[#7c8ca0]">
                    Status pengiriman paket harian
                  </p>
                </CardHeader>
                <CardContent className="space-y-4">
              ...
              <Card className="border-[#eef2f7] shadow-[0_18px_40px_rgba(15,42,67,0.08)]">
                ...
                <CardContent className="flex flex-col items-center gap-4">
                  ...
                  <div className="flex items-center gap-6 text-xs text-[#7c8ca0]">
                    {statusLogistics.map((entry) => (
